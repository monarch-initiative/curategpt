...
@pytest.mark.parametrize("query_vector,relevance_factor,expected",
                          [
...
def test_mmr(query_vector, relevance_factor, expected):
    ...
    diversified_order = mmr_diversified_search(query_vector, vectors, relevance_factor=relevance_factor)
